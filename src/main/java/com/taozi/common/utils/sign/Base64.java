package com.taozi.common.utils.sign;
...
public final class Base64 {
    ...
    static private final byte[] BASE_64_ALPHABET = new byte[BASE_LENGTH];
    static private final char[] LOOK_UP_BASE_64_ALPHABET = new char[LOOK_UP_LENGTH];
