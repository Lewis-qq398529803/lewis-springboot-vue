  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>Lewis后台管理框架</h2>
        <p>
          基础脚手架使用了若依3.7.0版本的ruoyi-vue，本身是作为自己的开发使用，需要原版的挺支持原作者，若依是一款非常实用的开源脚手架，我只作为二次开发进行使用，并且同时开源，提供我、大家进行开发。
        </p>
        <p>
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/Lewis-qq398529803/lewis-springboot-vue.git')"
            >访问码云</el-button
          >
          <el-button
            size="mini"
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="https://gitee.com/Lewis-qq398529803/lewis-springboot-vue.git"
                target="_blank"
                >https://gitee.com/Lewis-qq398529803/lewis-springboot-vue.git</el-link
              >
            </p>
            <p>
              <i class="el-icon-user-solid"></i> QQ：398529803
            </p>
            <p>
              <i class="el-icon-chat-dot-round"></i> 微信：398529803
            </p>
            <p>
              <i class="el-icon-money"></i> 支付宝：398529803@qq.com
            </p>
          </div>
        </el-card>
      </el-col>
