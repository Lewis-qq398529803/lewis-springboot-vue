  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>桃子后台管理框架</h2>
        <p>
          基于若依后台管理系统进行魔改，新增大量常用内容，提升开发效率，纯分享，不作商业用途，有兴趣请支持若依框架作者。
        </p>
        <p>
        ...
        <el-card class="update-log">
          ...
          <div class="body">
            ...
            <p>
              ...
              QQ群：
              <!-- <s>满937441</s> -->
              <a href="https://jq.qq.com/?_wv=1027&k=ru1P9q6n" target="_blank">
                820080257</a
              >
            </p>
            <p>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <el-collapse accordion>
            <el-collapse-item title="v1.0.0 - 2021.7.7">
              <ol>
                <li>桃子魔改若依前后端分离系统正式发布</li>
              </ol>
            </el-collapse-item>
          </el-collapse>
        </el-card>
